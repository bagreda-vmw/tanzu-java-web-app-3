...
```json
{
  ...
  "repositoryPrefix" : "709231817767.dkr.ecr.ap-southeast-1.amazonaws.com/22039580-4176-11ed-9e20-0202f20c5b5a"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [your-registry.io/project->709231817767.dkr.ecr...(truncated)]
